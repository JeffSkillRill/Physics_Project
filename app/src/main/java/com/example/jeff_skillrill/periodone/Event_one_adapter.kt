package com.example.jeff_skillrill.periodone
...
class Event_one_adapter(private var mList: List<Event_one_data>):
    RecyclerView.Adapter<Event_one_adapter.LanguageViewHolder>()
{
