package com.example.jeff_skillrill.period_three
...
class Event_three_adapter(private var mList: List<Event_one_data>):
    RecyclerView.Adapter<Event_three_adapter.LanguageViewHolder>()
{
    ...
    fun setFilteredList(mList: List<Event_one_data>) {
        this.mList = mList
        notifyDataSetChanged()
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LanguageViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.period_1_items, parent, false)
    ...
    override fun onBindViewHolder(
        holder: Event_three_adapter.LanguageViewHolder,
        position: Int,
